...
HD_PWD='/home/lguiga/Desktop/Lab1/Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log oct2ssd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source oct2ssd.tcl
