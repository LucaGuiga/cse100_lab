...
HD_PWD='/home/lguiga/Desktop/Lab1/Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log oct2ssd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source oct2ssd.tcl -notrace
